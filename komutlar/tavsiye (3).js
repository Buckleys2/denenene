...
let mesaj = args.slice(0).join(' ');
  ...
  const tavsiye1 = new Discord.RichEmbed()
    .setColor("RANDOM")
    .setDescription(message.author.username + ', <:basarili:437905292932415489>  Tavsiyeniz bildirildi! Tavsiyenizi bildirdiğiniz için teşekkür ederiz!')
...
return client.channels.get("437905292932415489").send(tavsiye);
};
